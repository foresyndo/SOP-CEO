...
import { Clipboard, Printer, CheckCircle, Plus, FileText, Landmark, User, LayoutGrid, Check, ArrowRight } from 'lucide-react';
      ...
      if (activeFormTab === 'investasi') {
        content = `
          ...
          <div style="float: right; text-align: center;">
            ...
            <p>Direktur Utama (CEO)</p>
            <br/><br/><br/>
            <p><strong>PT ${companyInfo.namaPerusahaan}</strong></p>
          </div>
        `;
                ...
                <div className="space-y-4 font-sans text-xs">
                  ...
                  <div className="pt-6 flex justify-end">
                    <div className="text-center text-[10px] font-sans">
                      ...
                      <div className="my-1.5 border-2 border-indigo-600/70 text-indigo-600/70 border-double text-[8.5px] font-bold py-1.5 px-3 rounded-full uppercase inline-block rotate-[-5deg] select-none mx-auto">
                        AUTHORIZED PT {companyInfo.namaPerusahaan.substring(0, 10)}
                      </div>
                      <p className="font-mono text-[9px] font-bold text-slate-400">SIGN OK // DATA SECURE</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-4 font-sans text-xs">
                  ...
                  <div className="pt-6 flex justify-end">
                    <div className="text-center text-[10px] font-sans">
                      <p>Jakarta, {anggaran.tanggalPengajuan}</p>
                      <p className="font-bold text-slate-900">Direktur Utama (CEO)</p>
                      <div className="my-1.5 border-2 border-emerald-600/70 text-emerald-600/70 border-double text-[8.5px] font-bold py-1.5 px-3 rounded-full uppercase inline-block rotate-[-3deg] select-none mx-auto">
                        BUDGET APPROVED 2026
                      </div>
                      <p className="font-mono text-[9px] font-bold text-slate-400">SIGN OK // FUNDS RESERVED</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-4 font-sans text-xs">
                  ...
                  <div className="pt-4 flex justify-end">
                    <div className="text-center text-[10px] font-sans">
                      <p>Jakarta, {evaluasi.tanggalEvaluasi}</p>
                      <p className="font-bold text-slate-900">Direktur Utama (CEO)</p>
                      <div className="my-1.5 border-2 border-indigo-600/70 text-indigo-600/70 border-double text-[8.5px] font-bold py-1 px-3 rounded-full uppercase inline-block rotate-[-5deg] select-none mx-auto">
                        PT {companyInfo.namaPerusahaan.substring(0, 10)} HR-BOARD
                      </div>
                      <p className="font-mono text-[9px] font-bold text-slate-400">EVAL RECORDED // ARCHIVED</p>
                    </div>
                  </div>
                </div>
              )}
